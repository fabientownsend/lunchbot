...
module RuboCop::FileFinder
  def find_file_upwards(filename, start_dir, use_home: nil); end
  def find_files_upwards(filename, start_dir, use_home: nil); end
...
class RuboCop::NodePattern::Compiler
  ...
  def compile_capt_ellip(tokens, cur_node, terms, index); end
  def compile_capture(tokens, cur_node, seq_head); end
  def compile_ellipsis(tokens, cur_node, terms, index); end
...
class RuboCop::AST::Node < Parser::AST::Node
  ...
  def shorthand_asgn?(node = nil); end
...
module RuboCop::Cop::PercentLiteral
  ...
  def correct_percent(node, char); end
  def end_content(source); end
  def ensure_valid_preferred_delimiters; end
  def escaped_content(word_node, escape, delimiters); end
  def line_breaks(node, source, previous_line_num, base_line_num, node_idx); end
...
module RuboCop::Cop::TrailingComma
  ...
  def heredoc?(source_after_last_item); end
...
class RuboCop::Cop::MultilineLiteralBraceCorrector
  ...
  def self.last_element_range_with_trailing_comma(node); end
  def self.last_element_trailing_comma_range(node); end
  def self.processed_source; end
...
class RuboCop::Cop::Layout::AccessModifierIndentation < RuboCop::Cop::Cop
  ...
  def check_modifier(send_node, class_start_col); end
...
class RuboCop::Cop::Layout::ClassStructure < RuboCop::Cop::Cop
  ...
  def find_category(method_name); end
...
class RuboCop::Cop::Layout::ClosingHeredocIndentation < RuboCop::Cop::Cop
  ...
  def contents_indentation(node); end
  def empty_heredoc?(node); end
...
class RuboCop::Cop::Layout::ClosingParenthesisIndentation < RuboCop::Cop::Cop
  ...
  def indentation_width; end
  def last_argument_line(elements); end
...
class RuboCop::Cop::Layout::EmptyLinesAroundAccessModifier < RuboCop::Cop::Cop
  ...
  def message(node); end
  def next_line_empty?(next_line); end
  def on_send(node); end
  def previous_line_empty?(previous_line); end
...
class RuboCop::Cop::Layout::RescueEnsureAlignment < RuboCop::Cop::Cop
  ...
  def autocorrect(node); end
  def check(node); end
  def format_message(kw_loc, end_loc); end
  def investigate(processed_source); end
...
class RuboCop::Cop::Layout::SpaceAroundBlockParameters < RuboCop::Cop::Cop
  ...
  def check_inside_pipes(args, opening_pipe, closing_pipe); end
  ...
  def check_space(space_begin_pos, space_end_pos, range, msg); end
...
class RuboCop::Cop::Lint::UselessSetterCall < RuboCop::Cop::Cop
  ...
  def on_def(node); end
  def on_defs(node); end
  def setter_call_to_local_variable?(node); end
end
...
class RuboCop::Cop::Metrics::LineLength < RuboCop::Cop::Cop
  ...
  def investigate(processed_source); end
  def line_in_whitelisted_heredoc?(heredocs, line_number); end
...
class RuboCop::Cop::Naming::MemoizedInstanceVariableName < RuboCop::Cop::Cop
  ...
  def valid_leading_underscore?(variable_name); end
  include RuboCop::Cop::ConfigurableEnforcedStyle
end
...
class RuboCop::Cop::Performance::Casecmp < RuboCop::Cop::Cop
  ...
  def downcase_eq_range(method, loc, send_downcase); end
  def eq_downcase(node = nil); end
  def inefficient_comparison(node); end
  def on_send(node); end
end
...
class RuboCop::Cop::Style::BlockDelimiters < RuboCop::Cop::Cop
  ...
  def ignored_method?(method_name); end
...
class RuboCop::Cop::Style::TernaryCorrector
  ...
  def self.ternary(condition, if_branch, else_branch); end
end
...
class RuboCop::Cop::Style::FlipFlop < RuboCop::Cop::Cop
  def on_eflipflop(node); end
  def on_iflipflop(node); end
end
class RuboCop::Cop::Style::For < RuboCop::Cop::Cop
  def incorrect_style_detected(method); end
  def on_block(node); end
  def on_for(node); end
  include RuboCop::Cop::ConfigurableEnforcedStyle
  include RuboCop::Cop::RangeHelp
...
class RuboCop::Cop::Style::HashSyntax < RuboCop::Cop::Cop
  ...
  def force_hash_rockets?(pairs = nil); end
...
class RuboCop::Cop::Style::Lambda < RuboCop::Cop::Cop
  def arg_to_unparenthesized_call?(arg_node); end
  def autocorrect(node); end
  def autocorrect_literal_to_method(corrector, node); end
  def autocorrect_method_to_literal(corrector, node); end
  def begin_pos(node); end
  ...
  def needs_whitespace?(block_method, args, node); end
  def offending_selector?(node, selector); end
  def on_block(node); end
  def remove_leading_whitespace(node, corrector); end
  def remove_trailing_whitespace(node, corrector); end
  def remove_unparenthesized_whitespace(corrector, node); end
  def unparenthesized_literal_args?(args); end
  include RuboCop::Cop::ConfigurableEnforcedStyle
end
...
class RuboCop::Cop::Style::MethodCallWithArgsParentheses < RuboCop::Cop::Cop
  ...
  def autocorrect(node); end
  def ignore_macros?; end
  def ignored_list; end
  def ignored_method?(node); end
  def on_send(node); end
  def on_super(node); end
  def on_yield(node); end
end
...
class RuboCop::Cop::Style::TernaryParentheses < RuboCop::Cop::Cop
  ...
  def message(node); end
  def method_call_argument(node = nil); end
...
class RuboCop::Cop::Style::YodaCondition < RuboCop::Cop::Cop
  ...
  def autocorrect(node); end
  def check_equality_only?; end
  def corrected_code(node); end
  def message(node); end
  def non_equality_operator?(operator); end
  def noncommutative_operator?(operator); end
  def on_send(node); end
  def reverse_comparison(operator); end
  def yoda_condition?(node); end
  include RuboCop::Cop::ConfigurableEnforcedStyle
  include RuboCop::Cop::RangeHelp
end
...
class RuboCop::Cop::Rails::HttpPositionalArguments < RuboCop::Cop::Cop
  ...
  def on_send(node); end
  def parentheses_format(node); end
...
class RuboCop::Cop::Rails::RelativeDateConstant < RuboCop::Cop::Cop
  ...
  def on_masgn(node); end
  def on_or_asgn(node); end
  def relative_date_method?(node); end
end
...
class RuboCop::Cop::Rails::SaveBang < RuboCop::Cop::Cop
  ...
  def join_force?(force_class); end
  def last_call_of_method?(node); end
  def on_send(node); end
...
class RuboCop::Formatter::DisabledConfigFormatter < RuboCop::Formatter::BaseFormatter
  ...
  def output_exclude_path(output_buffer, file, parent); end
...
class RuboCop::ConfigLoader
  ...
  def self.write_dotfile(file_string, rubocop_yml_contents); end
